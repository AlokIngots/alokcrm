...
import { convertTurnover, validateWebsite, formatWebsiteWithProtocol } from './utils/accountUtils';
...
const AddAccountModal = ({ isOpen, onClose, onAccountAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.SCM_KAM.trim()) {
        payload.SCM_KAM = formData.SCM_KAM.trim();
      }

      if (formData.TPT_KAM.trim()) {
        payload.TPT_KAM = formData.TPT_KAM.trim();
      }
